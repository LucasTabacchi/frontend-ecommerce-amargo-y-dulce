...
function PaginationControls(props: {
  ...
  return (
    <div className="mt-6 flex flex-col items-center gap-3 rounded-2xl border border-neutral-200 bg-white p-4 text-center shadow-sm md:flex-row md:items-center md:justify-between md:text-left">
